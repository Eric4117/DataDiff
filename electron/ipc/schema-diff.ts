...
export const COLUMN_COMPARE_FIELDS: { key: keyof ColumnInfo; label: string }[] = [
  { key: 'type', label: '类型' },
...
export function compareIndexes(leftIndexes: IndexInfo[], rightIndexes: IndexInfo[]): IndexDiff[] {
...
export function compareTableMeta(left: TableMeta, right: TableMeta): TableMetaDiff[] {
...
export function buildSummary(tables: TableDiff[]): DiffSummary {
